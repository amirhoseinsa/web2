...
function login() {
    ...
    xhttp.open("POST", "https://ce419.herokuapp.com/auth/login", true);
...
function create_post() {
    ...
    xhttp.open("POST", "https://ce419.herokuapp.com/blog/post", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function get_comments() {
    ...
    xhttp.open("GET", "https://ce419.herokuapp.com/blog/comments?post_id="+localStorage.getItem('current_id')+"&count=6&offset="+current_offset, true);
    xhttp.setRequestHeader("X-Token", localStorage.getItem('tt'));
    xhttp.send(null);
...
function signup(){
    ...
    oReq.open('POST', 'https://ce419.herokuapp.com/auth/register',true);
